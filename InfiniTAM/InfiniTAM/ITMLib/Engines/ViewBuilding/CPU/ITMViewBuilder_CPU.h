...
namespace ITMLib
{
	...
	public:
		...
		void UpdateView(ITMView **view, ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage, bool useBilateralFilter, bool modelSensorNoise = false, bool storePreviousImage = true);// 默认是存储上一帧图片的
